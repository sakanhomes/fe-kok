...
export const DislikeIcon: FC<TIcon> = ({ color, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M13.4285 13.4277C12.7394 11.9043 11.5965 11.142 9.99996 11.142C8.40338 11.142 7.26053 11.9043 6.57138 13.4277"
        stroke={palette[color ?? 'primary100']}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
